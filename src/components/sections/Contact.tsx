    ...
    >
      <Container className="py-20 md:py-28 lg:py-32">
        ...
        <a
          ...
          className="mt-10 inline-block break-all py-2 text-[length:clamp(1.5rem,4.6vw,3.75rem)] leading-tight font-semibold tracking-[-0.02em] underline decoration-band-signal decoration-2 underline-offset-[0.18em] transition-colors duration-150 hover:decoration-on-band md:mt-12"
        >
          {site.email}
        </a>
