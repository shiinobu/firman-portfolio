        ...
        >
          <nav aria-label="Mobile navigation">
              ...
              {navigationItems.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    onClick={closeMenu}
                    className="block border-b border-border-soft py-4 font-mono text-sm font-medium tracking-[0.08em] text-foreground-secondary transition-colors duration-200 hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary uppercase"
                  >
                    {item.label}
                  </Link>
                </li>
            ...
            <Link
              ...
              onClick={closeMenu}
              className="mt-4 flex min-h-12 items-center justify-center rounded-lg border border-border px-4 font-mono text-xs font-medium tracking-[0.08em] text-foreground transition-colors duration-200 hover:border-primary hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary uppercase"
            >
              GitHub ↗
            </Link>
          </nav>
